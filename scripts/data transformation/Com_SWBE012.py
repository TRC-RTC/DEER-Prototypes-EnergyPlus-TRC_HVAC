...
df_master = pd.read_excel('DEER_EnergyPlus_Modelkit_Measure_list_working_Windows_New.xlsx', sheet_name='Measure_list', skiprows=4)
...
measure_name = 'SWBE012-02 Windows'
...
filepath = f'commercial measures\SWBE012-02 Windows' #only changed this for testing
